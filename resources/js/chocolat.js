...
!(function (t) {
    ...
    t.extend(n.prototype, {
        ...
        load: function (e) {
            ...
            if (
                ...
                var s = this.preload(e)
                    ...
                    n = e + 1;
                return (
                    "undefined" != typeof this.settings.images[n] &&
                        this.preload(n),
                    s
                );
            }
        ...
        arrows: function () {
            this.settings.loop
                ? t([this.elems.left[0], this.elems.right[0]]).addClass(
                      "active"
                  )
                ...
                : t([this.elems.left[0], this.elems.right[0]]).removeClass(
                      "active"
                  );
        },
        ...
        storeImgSize: function (t, e) {
            "undefined" != typeof t &&
                ((this.settings.images[e].height &&
                    this.settings.images[e].width) ||
        ...
        markup: function () {
            this.elems.domContainer.addClass(
                ...
                (this.elems.top = t("<div/>", {
                    class: "chocolat-top",
                }).appendTo(this.elems.wrapper)),
                (this.elems.left = t("<div/>", {
                    class: "chocolat-left",
                }).appendTo(this.elems.wrapper)),
                (this.elems.right = t("<div/>", {
                    class: "chocolat-right",
                }).appendTo(this.elems.wrapper)),
                (this.elems.bottom = t("<div/>", {
                    class: "chocolat-bottom",
                }).appendTo(this.elems.wrapper)),
                (this.elems.close = t("<span/>", {
                ...
                t(e).on("resize", function () {
                    s.settings.initialized &&
                        ...
                        s.debounce(50, function () {
                            var t = s.fit(
                                s.settings.currentImage,
                                s.elems.wrapper
                            );
                            s.center(t.width, t.height, t.left, t.top, 0),
                                s.zoomable();
                        });
                });
        },
        zoomable: function () {
            var t = this.settings.images[this.settings.currentImage],
                ...
                s = !(
                    !this.settings.enableZoom || !(t.width > e || t.height > i)
                ),
                n =
    ...
    t.fn.Chocolat = function (e) {
        return this.each(function () {
            ...
            t.data(this, "chocolat") ||
                t.data(this, "chocolat", new n(t(this), i));
        });
    };
});
