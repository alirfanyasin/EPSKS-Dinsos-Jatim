            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="username" type="text" class="form-control" name="username" tabindex="1" :value="old('username')" required autofocus autocomplete="username" />
                                    <div class="invalid-feedback">
                                        Mohon lengkapi isian Username / Email
                                    </div>
                                </div>
                    ...
                    <div class="mt-2 text-muted text-center">
                        <a href="{{ route('employee.auth.login') }}">Login Dengan Kode</a>
                    </div>
