<ul class="sidebar-menu">
  ...
  @if (auth()->user()->hasRole('admin') && auth()->user()->pillar->id === \App\Models\Pillars\Pillar::PILLAR_PSM)
    <li class="nav-item dropdown {{ request()->routeIs('app.pillar.psm.*') ? 'active' : '' }}">
      ...
      <ul class="dropdown-menu">
        ...
        <li class='{{ request()->routeIs('app.pillar.psm.report.approval.*') ? 'active' : '' }}'>
          <a class="nav-link" href="{{ route('app.pillar.psm.report.approval.index') }}">Verifikasi Laporan</a>
        </li>
        {{-- <li class=''>
  ...
  @if (auth()->user()->hasRole('employee'))
    ...
    @else
      <li class="{{ request()->routeIs('app.employee.report.*') ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('app.employee.report.index') }}"><i class="fas fa-paper-plane"></i>
          <span>Laporan</span></a>
      </li>
    @endif
  @endif
