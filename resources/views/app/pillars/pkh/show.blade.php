                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                placeholder="Masukkan Nama Lengkap" value="{{ $data->name }}" readonly>
                                            @error('name')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nik" id="nik"
                                                ...
                                                placeholder="Masukkan NIK KTP" value="{{ $data->nik }}" readonly>
                                            @error('nik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tmt" id="tmt"
                                                ...
                                                placeholder="Masukkan TMT" value="{{ $data->tmt }}" readonly>
                                            @error('tmt')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="religion" id="religion" class="form-control" disabled>
                                                ...
                                                <option value="Kristen"
                                                    {{ $data->religion == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                                                <option value="Katolik"
                                                    {{ $data->religion == 'Katolik' ? 'selected' : '' }}>Katolik</option>
                                                <option value="Hindu" {{ $data->religion == 'Hindu' ? 'selected' : '' }}>
                                                    Hindu</option>
                                                <option value="Buddha" {{ $data->religion == 'Buddha' ? 'selected' : '' }}>
                                                    Buddha</option>
                                                <option value="Khonghucu"
                                                    {{ $data->religion == 'Khonghucu' ? 'selected' : '' }}>Khonghucu
                                                </option>
                                            </select>
                                            @error('religion')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email"
                                                ...
                                                value="{{ $data->email }}" placeholder="Masukkan Alamat Email" readonly>
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" id="address"
                                                ...
                                                value="{{ $data->address }}" placeholder="Masukkan Alamat" readonly>
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="no_npwp" id="no_npwp"
                                                ...
                                                value="{{ $data->no_npwp }}" placeholder="Masukkan Nomor NPWP" readonly>
                                            @error('no_npwp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            @if (!empty($data->education))
                                                @foreach ($data->education as $item)
                                                    <input type="text" name="education" id="education"
                                                        ...
                                                        value="{{ $item }}" placeholder="Masukkan Pendidikan"
                                                        readonly> <br>
                                                @endforeach
                                            @endif
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pt_origin" id="pt_origin"
                                                ...
                                                value="D3 - {{ $data->pt_origin_d3 }}" placeholder="D3 - Null" readonly>
                                            <br>
                                            <input type="text" name="pt_origin" id="pt_origin"
                                                class="form-control @error('pt_origin') is-invalid @enderror"
                                                value="S1 - {{ $data->pt_origin_s1 }}" placeholder="S1 - Null" readonly>
                                            <br>
                                            <input type="text" name="pt_origin" id="pt_origin"
                                                class="form-control @error('pt_origin') is-invalid @enderror"
                                                value="S2 - {{ $data->pt_origin_s2 }}" placeholder="S2 - Null" readonly>
                                            <br>
                                            <input type="text" name="pt_origin" id="pt_origin"
                                                class="form-control @error('pt_origin') is-invalid @enderror"
                                                value="S3 - {{ $data->pt_origin_s3 }}" placeholder="S3 - Null" readonly>
                                            <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="marital_status" id="marital_status" class="form-control"
                                                ...
                                                <option value="Belum Menikah"
                                                    {{ $data->marital_status == 'Belum Menikah' ? 'selected' : '' }}>
                                                    Belum
                                                    Menikah</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="number_of_children" id="number_of_children"
                                                class="form-control" placeholder="Tidak Ada"
                                                value="{{ $data->number_of_children }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="husband_or_wife_name" id="husband_or_wife_name"
                                                class="form-control" placeholder="Tidak Ada"
                                                value="{{ $data->husband_or_wife_name }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mother_name" id="mother_name"
                                                class="form-control" placeholder="Tidak Ada"
                                                value="{{ $data->mother_name }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="family_card_number" id="family_card_number"
                                                class="form-control" placeholder="Tidak Ada"
                                                value="{{ $data->family_card_number }}" readonly>
                                        </div>
                                    </div>
