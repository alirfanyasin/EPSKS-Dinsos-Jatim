  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active"><a href="{{ route('app.pillar.pkh.report.index') }}">Laporan</a></div>
    ...
    <div class="section-body">
      <h2 class="section-title">Revisi Laporan PKH</h2>
      <p class="section-lead">Program Keluarga Harapan</p>
      <div class="card">
        <div class="card-header">
          <h4>Revisi Laporan PKH</h4>
        </div>
        <div class="card-body">
          <form action="{{ route('app.pillar.pkh.report.revision-update', ['id' => $data->id]) }}" method="POST"
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="" value="{{ $data->type == 'daily' ? 'Harian' : 'Bulanan' }}"
                ...
                <div class="col-6 type-daily">
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control @error('date') is-invalid @enderror" name="date"
                      placeholder="Masukkan waktu" value="{{ $data->date }}">
                    @error('date')
                ...
                <div class="col-6 type-daily">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('venue') is-invalid @enderror" name="venue"
                      placeholder="Masukkan Tempat Kegiatan" value="{{ $data->venue }}">
                    @error('venue')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
