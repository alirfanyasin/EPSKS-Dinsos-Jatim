  ...
  <section class="section">
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <<<<<<< HEAD <ul class="nav nav-pills" role="tablist">
            ...
            <div class="tab-content">
              <div class="tab-pane fade show active" id="dailyReports" role="tabpanel" aria-labelledby="dailyReports">
                <div class="p-0 card-header">
                  ...
                  <div class="pt-0 card-body">
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="dailyReports" role="tabpanel"
                        aria-labelledby="dailyReports">
                        <div class="p-0 card-header">
                          <h4>Data Laporan Harian</h4>
                          @role('employee')
                            <a class="btn btn-success" href="{{ route('app.pillar.pkh.report.create') }}" type="button">
                          ...
                          <table class="table table-striped table-md" id="table-data-daily">
                            ...
                            <tbody>
                              ...
                              @foreach ($data_report as $key => $data)
                                ...
                                @endif
                                {{-- Modal --}}
                                <div class="modal fade" id="detailReportDaily{{ $key }}" tabindex="-1"
                                  ...
                                  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        >>>>>>> 81f917b94263cc48ded74b9afdd4f293e72372eb
                                      </div>
                                      <div class="table-responsive">
                                        <table class="table table-striped table-md" id="table-data-daily">
                                          <thead>
                                          ...
                                          <tbody>
                                            ...
                                            @foreach ($data_report as $key => $data)
                                              ...
                                              @endif
                                              {{-- Modal --}}
                                              <div class="modal fade" id="detailReportDaily{{ $key }}"
                                                      ...
                                                      <div class="row">
                                                        <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="exampleInputEmail1">Tipe
                                                              Pelaporan</label>
                                                            <input type="text" class="form-control" id="type_report"
                                                              disabled
                              ...
                              {{ $data->status == \App\Models\Review::STATUS_REVISION ? 'Revisi' : '' }}">
                                    ...
                                    <div class="tab-pane fade" id="monthlyReports" role="tabpanel"
                                      aria-labelledby="monthlyReports">
                                      <div class="p-0 card-header">
                                        ...
                                        <table class="table table-striped table-md" id="table-data-monthly">
                                          ...
                                          <tbody>
                                            ...
                                            @foreach ($data_report as $key => $data)
                                              ...
                                              {{-- Modal --}}
                                              <div class="modal fade" id="detailReportMonthly{{ $key }}"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                                                aria-hidden="true">
                                                <div class="modal-dialog modal-lg modal-dialog-centered"
                                                  role="document">
                                                    ...
                                                    <div class="modal-body">
                                                      ...
                                                      <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="exampleInputEmail1">Nama
                                                              Lengkap</label>
                                                            <input type="text" class="form-control" id="name_kartar"
                                                              disabled value="{{ $data->pkh->name }}">
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                          <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="regency"
                                                              disabled value="{{ $data->pkh->province }}">
                                                          </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                          <div class="form-group">
                                                            <label for="exampleInputEmail1">Kabupaten /
                                                              Kota</label>
                                                            <input type="text" class="form-control" id="distric"
                                                              disabled value="{{ $data->pkh->city }}">
                                                          </div>
                                                        </div>
                                                      ...
                                                      <div class="form-group">
                                                        <div class="row">
                                                          <div class="col-md-6">
                                                            <div class="form-group">
                                                              <label for="exampleInputEmail1">Dokumen
                                                                Laporan</label>
                                                              <div class="mb-3 input-group">
                                                                <input type="text" class="form-control"
                                                                  placeholder="Document" aria-label=""
                                                                  value="{{ $data->attachment_monthly }}" readonly>
                                                                <div class="input-group-append">
