                    ...
                    <form action="{{ route('app.pillar.pkh.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="phone" id="phone"
                                        ...
                                        value="{{ $data->phone }}" placeholder="Masukkan Nomor Telepon" required>
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control  @error('city') is-invalid @enderror"
                                        name="city" placeholder="Masukkan Kabupaten / Kota"
                                        value="{{ $kota }}" readonly>
                                    @error('city')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-small">
                                        <a href="{{ asset('storage/image/pillars/PKH/profile/' . $data->appointment_letter) }}"
                                            class="btn btn-primary my-2 d-block" target="_blank">Lihat File Sebelumnya</a>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="clothes_size" id="clothes_size"
                                        ...
                                        value="{{ $data->clothes_size }}" placeholder="Masukkan Ukuran Baju" required>
                                    @error('clothes_size')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="marital_status" id="marital_status" class="form-control">
                                        <option value="Menikah"
                                            {{ $data->marital_status == 'Menikah' ? 'selected' : '' }}>Menikah</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mother_name" id="mother_name"
                                        ...
                                        placeholder="Masukkan Nomor Kartu Keluarga" value="{{ $data->mother_name }}"
                                        required>
                                    @error('mother_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button type="submit" class="btn btn-icon btn-success" title="Simpan">Perbarui</button>
                            </div>
                        </div>
                    </form>
                </div>
