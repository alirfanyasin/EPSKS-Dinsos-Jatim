                ...
                <div class="card-body">
                    <ul class="nav nav-pills mb-3" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="master-tab" data-toggle="tab" href="#dataMaster" role="tab"
                                aria-controls="home" aria-selected="true">Data PKH</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade show active" id="dataMaster" role="tabpanel" aria-labelledby="master-tab">
                            <form action="{{ route('app.pillar.pkh.update', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="nik" id="nik"
                                                ...
                                                placeholder="Masukkan NIK KTP" value="{{ $data->nik }}" required>
                                            @error('nik')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tmt" id="tmt"
                                                ...
                                                placeholder="Masukkan TMT" value="{{ $data->tmt }}" required>
                                            @error('tmt')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="religion" id="religion" class="form-control">
                                                ...
                                                <option value="Kristen"
                                                    {{ $data->religion == 'Kristen' ? 'selected' : '' }}>
                                                    Kristen</option>
                                                <option value="Katolik"
                                                    {{ $data->religion == 'Katolik' ? 'selected' : '' }}>
                                                    Katolik</option>
                                                <option value="Hindu" {{ $data->religion == 'Hindu' ? 'selected' : '' }}>
                                                    Hindu
                                                </option>
                                                <option value="Buddha" {{ $data->religion == 'Buddha' ? 'selected' : '' }}>
                                                    Buddha
                                                </option>
                                                <option value="Khonghucu"
                                                    {{ $data->religion == 'Khonghucu' ? 'selected' : '' }}>
                                                    Khonghucu</option>
                                            </select>
                                            @error('religion')
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="place_of_birth">Tempat Lahir <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" name="place_of_birth" id="place_of_birth"
                                                class="form-control @error('place_of_birth') is-invalid @enderror"
                                                value="{{ $data->place_of_birth }}" placeholder="Masukkan Tempat Lahir"
                                                required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="date_of_birth">Tanggal Lahir <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="date_of_birth" id="date_of_birth"
                                                class="form-control @error('date_of_birth') is-invalid @enderror"
                                                value="{{ $data->date_of_birth }}" placeholder="Masukkan Tanggal Lahir"
                                                required>
                                            @error('date_of_birth')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" id="email"
                                                ...
                                                value="{{ $data->email }}" placeholder="Masukkan Alamat Email" required>
                                            @error('email')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone" id="phone"
                                                ...
                                                value="{{ $data->phone }}" placeholder="Masukkan Nomor Telepon"
                                                required>
                                            @error('phone')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address" id="address"
                                                ...
                                                value="{{ $data->address }}" placeholder="Masukkan Alamat" required>
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="province" placeholder="Masukkan Provinsi" value="JAWA TIMUR"
                                                readonly>
                                            @error('province')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="Masukkan Kabupaten / Kota" value="{{ $kota }}"
                                                readonly>
                                            @error('city')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="no_npwp" id="no_npwp"
                                                ...
                                                value="{{ $data->no_npwp }}" placeholder="Masukkan Nomor NPWP" required>
                                            @error('no_npwp')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="appointment_letter">SK Pengangkatan <span
                                                    class="text-danger">*</span></label>
                                            ...
                                            <div class="text-small">
                                                <a href="{{ asset('storage/image/pillars/PKH/profile/' . $data->appointment_letter) }}"
                                                    class="my-2 btn btn-primary d-block" target="_blank">Lihat File
                                                    Sebelumnya</a>
                                ...
                                <div class="row">
                                            ...
                                            <div>
                                                ...
                                                @foreach ($educationLevels as $level)
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="education[]"
                                                            type="checkbox" value="{{ $level }}"
                                                            id="{{ strtolower($level) }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="pt_origin">Asal Perguruan Tinggi <span
                                                    class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="marital_status" id="marital_status" class="form-control">
                                                <option value="Menikah"
                                                    {{ $data->marital_status == 'Menikah' ? 'selected' : '' }}>Menikah
                                                </option>
                                                <option value="Belum Menikah"
                                                    {{ $data->marital_status == 'Belum Menikah' ? 'selected' : '' }}>Belum
                                                    Menikah</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="husband_or_wife_name" id="husband_or_wife_name"
                                                ...
                                                placeholder="Masukkan Nama Suami atau Istri"
                                                value="{{ $data->husband_or_wife_name }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="mother_name">Nomor Ibu Kandung <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="family_card_number" id="family_card_number"
                                                ...
                                                placeholder="Masukkan Nomor Kartu Keluarga"
                                                value="{{ $data->family_card_number }}" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="no_bpjs" id="no_bpjs"
                                                ...
                                                value="{{ $data->no_bpjs }}" placeholder="Masukkan Nomor BPJS">
                                            @error('no_bpjs')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <a type="button" href="{{ route('app.pillar.pkh.index') }}"
                        ...
                        <div class="tab-pane fade" id="dataTraining" role="tabpanel" aria-labelledby="training-tab">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <a {{-- href="/app/pillar/pkh/member/create/{{ $data->id }}
                                    " --}} href="/app/pillar/pkh/training/create/{{ $data->id }}"
                                        class="btn btn-icon btn-success" title="Tambah Pengurus"
                                        style="margin-bottom: 20px"><i class="fas fa-plus"></i>
                                        Tambah Data</a>
                        ...
                        @foreach ($data_training as $data_training_member) --}}
                                                ...
                                                @foreach ($data_training as $data_training_member)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ asset('storage/image/pillars/pkh/certificate/' . $data_training_member->certificate) }}"
