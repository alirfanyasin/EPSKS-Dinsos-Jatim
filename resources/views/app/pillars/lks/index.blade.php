                  ...
                  <tr>
                    ...
                    <td>
                      <div class="flex-row flex-wrap d-flex">
                        <a href="{{ route('app.pillar.lks.show', $lks->hash) }}" class="btn btn-sm btn-info w-100"
                          title="Detail">Detail Data</a>
                        <a href="{{ route('app.pillar.lks.report.lks_report', $lks->hash) }}"
                          class="mt-2 btn btn-sm btn-warning w-100" title="Detail Laporan">Detail Laporan</a>
                      </div>
                    </td>
                    <td>
                      <div class="flex-row flex-wrap d-flex">
                        <a href="{{ route('app.pillar.lks.edit', $lks->hash) }}" class="btn btn-sm btn-primary w-100"
                          title="Edit">Edit Data</a>
                        <div class="w-100">
                          <form action="{{ route('app.pillar.lks.destroy', $lks->hash) }}" class="formDelete"
                            method="POST">
                            @csrf
                            @method('delete')
