              ...
              <div class="p-0 card-header">
                ...
                @role('employee')
                  ...
                  <div class="dropdown d-inline">
                    <button class="border-2 btn border-danger dropdown-toggle text-danger" style="margin-left: 10px"
                      type="button" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true"
                      aria-expanded="false">
                      <i class="fas fa-file-download text-danger"></i> Export Data
                    </button>
                    <div class="dropdown-menu">
                      <a class="dropdown-item has-icon"
                        href="{{ route('app.pillar.kartar.report.export_pdf', ['select' => 'harian', 'name' => Auth::user()->name]) }}"><i
                          class="fas fa-file-pdf"></i>
                        PDF</a>
                      <a class="dropdown-item has-icon"
                        href="{{ route('app.pillar.kartar.report.export_excel', ['select' => 'harian', 'name' => Auth::user()->name]) }}"><i
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="{{ route('app.pillar.kartar.report.approval.verification', $data->id) }}"
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="mb-3 input-group">
                                          <a href="{{ asset('storage/image/pillars/kartar/report/' . $data->image) }}"
                                            target="_blank">
                                            <img
                                              src="{{ asset('storage/image/pillars/kartar/report/' . $data->image) }}"
                                              class="w-100" alt="">
                                          </a>
                                        </div>
                                      </div>
                                ...
                                @role('admin|super-admin')
                                  <div class="row">
                                    <div class="col-12">
                                      <a type="button" href="{{ route('app.pillar.kartar.report.approval.index') }}"
