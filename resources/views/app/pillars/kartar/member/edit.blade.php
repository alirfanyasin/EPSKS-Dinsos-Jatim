        ...
        <div class="card-body">
          ...
          <div class="tab-content" id="myTabContent2">
            <div class="tab-pane fade show active" id="dataMaster" role="tabpanel" aria-labelledby="master-tab">
              <form
                action="{{ route('app.pillar.kartar.member.update', ['member_id' => $data_member->id, 'kartar_id' => $data_kartar->id]) }}"
                ...
                <div class="row">
                  <div class="col-12">
                    <a type="button" href="{{ route('app.pillar.kartar.edit', $data_kartar->id) }}"
              ...
              <div class="row">
                <div class="col-4">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form
                        action="/app/pillar/kartar/member/training/store/{{ $data_member->id }}/{{ $data_kartar->id }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- Member id --}}
                          ...
                          <tbody>
                            ...
                            @foreach ($data_training as $data_training_member)
                              <tr>
                                ...
                                <td><a
                                    href="{{ asset('storage/image/pillars/kartar/certificate/' . $data_training_member->certificate) }}"
                                    class="text-danger" target="_blank"><i class="far fa-file-pdf"
                                      style="font-size: 30px;"></i></a>
                                </td>
                                <td>
                                  <form action="{{ route('app.pillar.kartar.member.training.delete') }}"
