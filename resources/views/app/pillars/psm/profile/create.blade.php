...
@section('content')
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Tambah Data PSM</h2>
            <p class="section-lead">Pekerja Sosial Masyarakat</p>
            <div class="card">
                <div class="card-header">
                    <h4>Tambah Data PSM</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('app.pillar.psm.profile.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('membership_number') is-invalid @enderror membership_number" name="membership_number" placeholder="Masukkan Nomor Induk Anggota PSM (IPSM)" value="{{ old('membership_number') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <label>Desa / Kelurahan</label>
                                    <select class="form-control @error('duty_address.village') is-invalid @enderror" id="task-village" name="duty_address[village]" required></select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('year_of_appointment') is-invalid @enderror" name="year_of_appointment" value="{{ old('year_of_appointment') }}" placeholder="Massukan Tahun Pengangkatan IPSM" maxlength="4" required>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('technical_guidance.certificate_number') is-invalid @enderror" name="technical_guidance[certificate_number]" value="{{ old('technical_guidance.certificate_number') }}" placeholder="Masukkan No. Sertifikat Bimtek Dasar" required="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('technical_guidance.organizer') is-invalid @enderror" name="technical_guidance[organizer]" value="{{ old('technical_guidance.orginazer') }}" placeholder="Masukkan Penyelenggara Bimtek Dasar" required="">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('technical_guidance.certificate_date') is-invalid @enderror" name="technical_guidance[certificate_date]" value="{{ old('technical_guidance.certificate_date') }}" placeholder="Masukkan Tanggal Sertifikat" required="">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('technical_guidance.certificate_path') is-invalid @enderror" name="technical_guidance[certificate_path]" accept="application/pdf" required>
