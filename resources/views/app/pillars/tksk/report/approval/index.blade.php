    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('app.pillar.tksk.index') }}"> TKSK</a></div>
                <div class="breadcrumb-item"> Verifikasi Laporan</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Verifikasi Laporan TKSK</h2>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">NIAT</label>
                                                            <input type="email" class="form-control niat" id="niat" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <form action="#" id="monthlyForm" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">NIAT</label>
                                                            <input type="email" class="form-control niat" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-monthly-submit').click(function () {
                ...
                $('#monthlyForm').attr('action', route('app.pillar.tksk.report.approval.store', hash));
            })
