  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active"><a href="{{ route('app.pillar.tksk.report.index', $tksk->hash) }}">Laporan</a>
        </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form action="{{ route('app.pillar.tksk.report.store', $tksk->hash) }}" method="POST"
            enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-12">
                <div class="mt-0 section-title">Pilih Jenis Laporan</div>
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="" value="{{ Auth::user()->tksk->name }}"
                    disabled>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name=""
                    value="{{ Auth::user()->tksk->membership_number }}" disabled>
                </div>
              </div>
            </div>
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control  @error('venue') is-invalid @enderror" name="venue"
                      placeholder="Masukkan Tempat Kegiatan" value="{{ old('venue') }}">
                    @error('venue')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
              ...
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control  @error('activity') is-invalid @enderror" name="activity"
                      placeholder="Masukkan Aktivitas yang dilakukan" value="{{ old('activity') }}">
                    @error('activity')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
                ...
                <div class="col-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control  @error('constraint') is-invalid @enderror"
                      name="constraint" placeholder="Masukkan Kendala" value="{{ old('constraint') }}">
                    @error('constraint')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
            ...
            <div class="type-monthly" hidden>
              <div class="row">
                <div class="col-6">
                  <div class="form-group">
                    <label>Bulan</label>
                    <input type="month" class="form-control @error('date_monthly') is-invalid @enderror"
                      name="date_monthly" placeholder="Masukkan Bulan" value="{{ old('date_monthly') }}">
                    @error('date_monthly')
                      <div class="invalid-feedback">
                        {{ $message }}
                      </div>
            ...
            <div class="row">
              <div class="col-12">
                <a type="button" href="{{ route('app.pillar.tksk.report.index', $tksk->hash) }}"
