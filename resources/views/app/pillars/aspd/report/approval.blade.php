                                                        ...
                                                        @role('admin')
                                                            <td>
                                                                <button type="button" class="btn btn-primary btn-detail"
                                                                    data-toggle="modal"
                                                                    data-target="#detailReportDaily{{ $key }}">Verifikasi
                                                                    Laporan</button>
                                                            </td>
                                                        @endrole
                                                    </tr>
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ route('app.pillar.aspd.report.approval.update-status', ['id' => $data->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="type_report" disabled
                                                                                value="{{ $data->aspd->nik }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Tanngal
                                                                                Pelaporan</label>
                                                                            <input type="text" class="form-control"
                                                                                id="date" disabled
                                                                                value="{{ $data->date }}">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select name="status" id=""
                                                                                        ...
                                                                                        <option value="approved">Setuju
                                                                                        </option>
                                                                                        <option value="revision">Revisi
                                                                                        </option>
                                                                ...
                                                                @role('admin|super-admin')
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <a type="button"
                                                                                href="{{ route('app.pillar.aspd.report.approval.index') }}"
                                                                                class="btn btn-icon btn-danger"
                                                                                title="Batal">Batal</a>
                                                                            <button type="submit"
                                                                                class="btn btn-icon btn-success">Simpan</button>
                                                                        </div>
                                                                    </div>
                                                                @endrole
                                                            </form>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @role('admin')
                                                            <td>
                                                                <button type="button" class="btn btn-primary btn-detail"
                                                                    data-toggle="modal"
                                                                    data-target="#detailReportMonthly{{ $key }}">Verifikasi
                                                                    Laporan</button>
                                                            </td>
                                                        @endrole
                                                    </tr>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="mb-3 input-group">
                                                                                    <a href="{{ asset('storage/image/pillars/ASPD/report/' . $data->attachment_monthly) }}"
                                                                                        target="_blank">
                                                                                        <img src="{{ asset('storage/image/pillars/ASPD/report/' . $data->attachment_monthly) }}"
                                                                                            class="w-100" alt="">
                                                                                    </a>
                                                                                </div>
                                                                            </div>
