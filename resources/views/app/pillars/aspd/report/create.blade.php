    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('app.pillar.aspd.index') }}">Laporan</a></div>
                <div class="breadcrumb-item active"><a href="{{ route('app.pillar.aspd.report.show', 1) }}">Detail
                        Laporan</a></div>
        ...
        <div class="section-body">
            <h2 class="section-title">Tambah Laporan ASPD</h2>
            <p class="section-lead">Asistensi Sosial Pendamping Disabilitas</p>
            <div class="card">
                <div class="card-header">
                    <h4>Tambah Laporan ASPD</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('app.pillar.aspd.report.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-6 type-daily" hidden>
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        value="" name="date" placeholder="Masukkan waktu">
                                    @error('date')
                            ...
                            <div class="col-6 type-daily" hidden>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('venue') is-invalid @enderror"
                                        value="" name="venue" placeholder="Masukkan Tempat Kegiatan">
                                    @error('venue')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="month" class="form-control @error('month') is-invalid @enderror"
                                            name="month" placeholder="Masukkan Bulan">
                                        @error('month')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
