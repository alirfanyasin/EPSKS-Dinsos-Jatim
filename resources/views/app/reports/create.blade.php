    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ route('app.employee.report.index') }}">Data Pelaporan</a>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('app.employee.report.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a type="button" href="{{ route('app.employee.report.index') }}"
