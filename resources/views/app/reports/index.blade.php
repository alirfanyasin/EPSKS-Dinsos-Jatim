                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="dailyReports" role="tabpanel" aria-labelledby="dailyReports">
                            <div class="card-header p-0">
                                ...
                                <a class="btn btn-outline-danger ml-3" href="{{ route('app.employee.report.export') }}" type="button">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    @if($dailyReport->status === 'revision')
                                                        <a href="{{ route('app.employee.report.edit', $dailyReport->hash) }}" class="btn btn-warning btn-revision" data-id="{{ $dailyReport->hash }}">Revisi</a>
                                                    @else
                                                        <button type="button" class="btn btn-primary btn-daily-detail" data-id="{{ $dailyReport->hash }}">Lihat Detail</button>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal fade" id="detailDailyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
{{--                                            <td>{{ $monthlyReport->tksk->membership_number }}</td>--}}
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    @if($monthlyReport->status === 'revision')
                                                        <a href="{{ route('app.employee.report.edit', $monthlyReport->hash) }}" class="btn btn-warning btn-revision" data-id="{{ $dailyReport->hash }}">Revisi</a>
                                                    @else
                                                        <button type="button" class="btn btn-primary btn-monthly-detail" data-id="{{ $monthlyReport->hash }}">Lihat Detail</button>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal fade" id="detailMonthlyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
