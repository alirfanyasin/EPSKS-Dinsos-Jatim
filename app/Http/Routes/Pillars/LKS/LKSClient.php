...
use App\Http\Controllers\Pillars\LKS\LKSClientController;
use Dentro\Yalr\BaseRoute;

class LKSClient extends BaseRoute
{
    protected string $prefix = 'app/pillar/lks/client';
    protected string $name = 'app.pillar.lks.client';
    /**
    ...
    {
        return LKSClientController::class;
    }
}
