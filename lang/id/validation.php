...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'nik' => 'No KTP / NIK',
        'membership_number' => 'Nomor Induk Anggota',
        'place_of_birth' => 'Tempat Lahir',
        'date_of_birth' => 'Tanggal Lahir',
        'age' => 'Umur',
        'gender' => 'Jenis Kelamin',
        'religion' => 'Agama',
        'phone_number' => 'No. Handphone / Whatsapp',
        'last_education' => 'Pendidikan Terakhir',
        'year_of_appointment' => 'Tahun Pengangkatan',
        'main_job' => 'Pekerjaan Utama',
        'is_active' => 'Status Aktif',
        'annual_evaluation_grade' => 'Penilaian Tahunan',
        'address' => 'Alamat',
        'address.full_address' => 'Alamat Lengkap',
        'address.regency' => 'Kabupaten / Kota',
        'address.district' => 'Kecamatan',
        'address.village' => 'Kelurahan',
        'address.rt' => 'RT',
        'address.rw' => 'RW',
        'duty_address' => 'Alamat Tugas',
        'duty_address.regency' => 'Kabupaten / Kota',
        'duty_address.district' => 'Kecamatan',
        'bank_accounts.bank_jatim' => 'Bank Jatim',
        'bank_accounts.bank_bni' => 'Bank BNI',
